...
router_agent = Agent(
    ...
    system_prompt=(
        ...
        "Given a user request, decide the authentication modality. Use the choose_modality function for this."
...
def choose_modality(instruction: str) -> ModalityChoice:
    ...
    return router_agent.run_sync(instruction)       # todo: change run_sync to run if 